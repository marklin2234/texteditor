...
void changed_cb(int, int nInserted, int nDeleted, int, const char*, void* v) {
  ...
  set_title(e);
  if (loading) e->editor->show_insert_position();
}
...
EditorWindow::EditorWindow(int w, int h, const char* t)
    ...
    editor = new Fl_Text_Editor(0, 30, w, h);
...
void EditorWindow::createMenuBar() {
  Fl_Menu_Item menuitems[] = {
    ...
    { "&Search", 0, 0, 0, FL_SUBMENU },
        ...
        { "F&ind Again",    FL_COMMAND + 'g', find2_cb, this },
        { "&Replace...",    FL_COMMAND + 'r', replace_cb, this },
        { "Re&place Again", FL_COMMAND + 't', replace2_cb, this },
        { 0 },
